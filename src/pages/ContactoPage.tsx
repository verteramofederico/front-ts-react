    ...
    <section className="bg-white dark:bg-gray-900">
        <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
            ...
            <form action="#" className="space-y-8">
                ...
                <div>
                    <label htmlFor="subject" className="block mb-2 text-sm font-medium text-primary dark:text-gray-300">
                    Sujeto
                    </label>
                    <input type="text" id="subject" className="block p-3 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 shadow-sm focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light" placeholder="Breve descripcion de su consulta" required />
                </div>
