        ...
        <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div>
                    ...
                    <input /* value={formData.nombre} */ onChange={handleChange} type="text" id="text" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light" placeholder="sucorreo@proveedor.com" required />
                </div>
                ...
                <div>
                    ...
                    <input /* value={formData.email} */ onChange={handleChange} type="email" id="email" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light" placeholder="sucorreo@proveedor.com" required />
                </div>
